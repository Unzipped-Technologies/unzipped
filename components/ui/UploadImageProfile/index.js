      ...
      <FirstSubUploadContainer>
        ...
        <SecondSubUploadContainer>
          ...
          <StyledTitleContainer>
            <StyledFlexContainer>
              <UploadInput type="file" inputId="uploadBtn" label={'Upload new image'} uploadFile={handleOnChange} />
              {photoToLoad && (
                <>
            ...
            {showError ? (
              <StyledFlexContainer>
                <Icon name="exclaimPoint" /> <WarningTextRed>{'Please upload a valid image'}</WarningTextRed>
              </StyledFlexContainer>
            ) : (
              <WarningText>
                {imageName
                  ? `${subTitle ? 'Fund Image' : 'Title'}: ${imageName}`
                  : `${subTitle ? 'Fund Image' : 'Title'}: (Image must not exceed ${imgWidth}x${imgHeight})`}
              </WarningText>
            )}
          </StyledTitleContainer>
        </SecondSubUploadContainer>
