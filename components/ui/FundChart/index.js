          ...
          {!fundClosed && (
            <>
              ...
              <LowerDisplayContainer>
                ...
                <LowerDisplayCurrency>{ConverterUtils.convertToCurrency(closeReady)}</LowerDisplayCurrency>
              </LowerDisplayContainer>
            </>
          )}
        </LowerDisplayUpperContainer>
          ...
          <>
            <LowerDisplayLowerContainer>
              ...
              <LowerDisplayContainer>
                ...
                <LowerDisplayCurrency>{ConverterUtils.convertToCurrency(legalHold)}</LowerDisplayCurrency>
              </LowerDisplayContainer>
              <DisplaySquare $color={theme.important}></DisplaySquare>
              <LowerDisplayContainer>
                <LowerDisplayText>In Progress:</LowerDisplayText>
                <LowerDisplayCurrency>{ConverterUtils.convertToCurrency(inProgress)}</LowerDisplayCurrency>
              </LowerDisplayContainer>
            </LowerDisplayLowerContainer>
          </>
        )}
