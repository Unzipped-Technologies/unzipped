...
const UploadBox = styled.div`
  ...
  align-items: center;
  padding: 13px 18px;
  border: 2px ${props => (props.$fileName || props.$defaultFileName ? 'solid' : 'dashed')} ${props => props.theme.tint3};
  ...
  <FileUploadContainer>
    ...
    <div>
      <StyledFileDrop onDrop={e => handleFileChange(e, 'drop')}>
        <UploadContainer>
          <UploadBox $fileName={!isError && fileName} $defaultFileName={!isError && defaultFileName} $isError={isError}>
                ...
                <StyledRow>
                  {!isError && (
                    <SubText>
                      ...
                      {isView && (isReplace || isEdit || isDelete || isDownload || isRestore) && <> &bull; </>}
                      {isReplace && (
                        <InputComponent
                      ...
                      {isReplace &&
                        ((isRestore && defaultFileName !== fileName) || isEdit || isDelete || isDownload) && (
                          <> &bull; </>
                        )}
                      ...
                      {isRestore && defaultFileName !== fileName && (isEdit || isDelete || isDownload) && <> &bull; </>}
                      {isEdit && (
                        <InputComponent
