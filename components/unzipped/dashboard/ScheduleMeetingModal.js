                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div>
                                    ...
                                    <Label>
                                        Select your working hours and the times you will likely be available for an interview.
                                        You will always receive an optional request from the client for interviews.
                                    </Label>
                                </div>
                                ...
                                <div>
                                    <TextTitleStyled weight={400} color="#1976D2">Prefer to use Calendly?</TextTitleStyled>
                                </div>
                                {/* <div>
