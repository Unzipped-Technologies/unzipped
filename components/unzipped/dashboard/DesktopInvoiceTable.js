    ...
    if (role === 1) {
      return [
        {
          ...
          onClick: () => {
            router.push(
              ...
              `/dashboard/projects/freelancer/invoice/${rowData.businessId}?tab=invoices`
            )
          }
        }
      ]
      ...
      return [
        ...
        },
        {
          text: 'View Details',
          onClick: () => {
            router.push(`/dashboard/projects/client/invoice/[_id]?tab=invoices&freelancer=${rowData.freelancerId}`)
          }
        },
        {
          text: 'View Profile',
