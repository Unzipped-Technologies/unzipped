...
const CreateBusiness = ({mobile, titleFontSize, doubleScreenTop, doubleScreenBottom, title, loading, disabled, submit, skip, sub, children, stage, progress=10, onBack, onSubmit, onUpdate, noMargin, noTitle}) => {
    return (
      <CardContainer>
        <Card
