...
const ReviewBusinessDetails = ({ files = [], isGithubConnected, stage, isMobileViewActive = false }) => {
  ...
  const handleSubmitProject = () => {
    ...
    dispatch(createBusiness(formData, accessToken, true))
  }
  ...
  return (
    <ReviewContainer>
      <ReviewContent>
        ...
        <ReviewSectionStyled>
          <ReviewHeaderSection label={BUSINESS_LABEL.project.requirements} isEditIconDisplayed={true} step={5} isMobileViewActive={isMobileViewActive} />
        ...
        {businessForm?.teamDynamics && (
          <ReviewSectionStyled>
            <ReviewHeaderSection label={BUSINESS_LABEL.project.dynamics} isEditIconDisplayed={true} step={4} isMobileViewActive={isMobileViewActive}/>
            <Items>
        ...
        {businessForm?.goals && (
          <ReviewSectionStyled>
            <ReviewHeaderSection label={BUSINESS_LABEL.project.goals} isEditIconDisplayed={true} step={6} isMobileViewActive={isMobileViewActive}/>
            <Items>
        ...
        {businessForm?.companyBackground && (
          <ReviewSectionStyled>
            <ReviewHeaderSection label={BUSINESS_LABEL.project.background} isEditIconDisplayed={true} step={7} isMobileViewActive={isMobileViewActive} />
            <Items>
        ...
        <ReviewSectionStyled>
          ...
          {files.length > 0 && (<div style={{ marginTop: 30, display: 'flex', width: '100%', flexDirection: 'column', gap: '10px' }}>
        ...
        {isGithubConnected && (
          <ReviewSectionStyled>
            <ReviewHeaderSection label={GITHUB_INFO_LABEL} isEditIconDisplayed={false} step={0} isMobileViewActive={isMobileViewActive}/>
