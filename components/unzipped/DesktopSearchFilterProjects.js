...
function DesktopSearchFilterProjects({ handleProjectTypes, maxRate, setMaxRate, setMinRate, minRate, freelancerSkillsList, setSkill }) {
    const minRef = useRef()
    const maxRef = useRef()
    ...
    return (
        <Container>
            <div>
                <P fontSize='20px' fontWeight='600'>Filters</P>
                <div className='d-flex justify-content-between pt-4 pb-4'>
                    <P fontSize='20px' fontWeight='600'>Project type</P>
                    <P cursor='pointer' fontSize="18px" fontWeight="500" color="#0057FF" onClick={handleClearProjectType}>Clear</P>
                </div>
                ...
                <div>
                    <P margin='10px 0 0 0' fontSize='18px' fontWeight='600'>min</P>
