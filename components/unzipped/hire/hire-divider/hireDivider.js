...
import { getFontStyled, COLORS, LETTER_SPACING, FONT_SIZE } from '../../../ui/TextMaskInput/core/utilities'
...
const HireDivider = ({ title }) => {
  return (
    <>
      ...
      <ResponsiveHeader>
        <BackIcon color="#000" />
        <NotificationText fontSize="16px" fontWeight="600" width="100%" marginLeft="20px">
