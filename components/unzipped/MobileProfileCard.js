    ...
    return (
        <>
            <div className='text-center'>
                ...
                <div style={{ padding: "75px 16px 16px 16px", }} >
                    ...
                    <div style={{ position: "relative" }}>
                        {user?.likeTotal !== 0 && <div style={{ position: "absolute", right: "30px", display: "flex", alignItems: "center" }}>
                    ...
                    <div className='d-flex' style={{ textAlign: "start", gap: "10px" }}>
                        ...
                        <div>
                            <P fontSize='14px' fontWeight="300">{formatDate(user?.updatedAt)}</P>
                    ...
                    <div className='d-flex' onClick={(e) => {
                        ...
                        <div style={{ borderLeft: "1.3px solid #B5B5B5", background: "#37DEC5" }}>
                            <button style={{ background: "#37DEC5", color: "white", fontSize: "16px", border: "0", padding: "16px 13px", fontWeight: "600" }} ><IconComponent name='downArrow' width="20" height="20" viewBox="0 0 20 20" fill="white" /></button>
                        </div>
                    </div>
                </div>
            </div >
            ...
            <ProjectCard>
                ...
                <P margin='0 0 5px' fontSize="15px" >{user?.category}</P>
                <P margin='0 0 14px' fontSize="14px" fontWeight="300">{user?.user?.AddressLineCountry || 'United States'}</P>
                ...
                <div style={{ padding: "0px 19px", display: "flex" }}>
                    <img src='/img/projectImages.png' style={{ marginRight: "7px", width: "70%", height: "auto" }} alt={`Image`} />
            ...
            <OtherInformationBox>
                <OtherInformationCard>
                    <P fontWeight="700" borderBottom="1px solid #D9D9D9" padding="10px">Top Skills</P>
                ...
                <OtherInformationCard>
                    <P fontWeight="700" borderBottom="1px solid #D9D9D9" padding="10px">Education</P>
                    <P padding="0 10px" fontWeight="500">Engineer</P>
                    <P padding="0 10px" margin='0'>Ecole centrale de Lyon, France</P>
