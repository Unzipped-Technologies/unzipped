...
const UpdateProfileModal = ({
  ...
  const onSubmit = async () => {
    if (
      userData?.AddressLineCountry !== user?.AddressLineCountry &&
              ...
              <div
                ...
                <DIV display="flex" alignItems="center">
                  <FormField
                    ...
                    maxLength="30"
                    min={0}
                    onChange={e => updateForm('AddressLineTwo', e.target.value)}></FormField>
                </DIV>
                ...
                <DIV display="block" margin="5px 0px 15px 0px" alignItems="center" position="relative">
                  ...
                  <p
                    ...
                    This is so we can verify your address details. The country will be automatically updated once the
                    process is complete.
                  </p>
                </DIV>
