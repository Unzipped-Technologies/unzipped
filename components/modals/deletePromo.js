...
import { delPromos } from '../../redux/actions';
...
const SimpleModal = ({open, setOpen, token, deletes}) => {
    ...
    const handleDelete = () => {
        dispatch(delPromos(deletes, token));
        setOpen(false);
    }
        ...
        <div>
            ...
            >
                <div style={modalStyle} className={classes.paper}>
                    <h5>Are you sure you want to delete {deletes.length > 1 ? 'these promos?' : 'this promo?'}</h5>
                    <div className="add-user-form">
                        {deletes.length === 0 &&
                            <p style={{textAlign: 'center', paddingTop: '10px'}}>Select promos to delete...</p>
                        }
...
export default connect(null, {delPromos})(SimpleModal);