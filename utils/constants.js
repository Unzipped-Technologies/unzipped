export default {
    ...
    ACCREDITED_EVENT_2:
        'This is a serious situation which is almost never advisable. Please consult your legal adviser.',
    EEA_WARNINGS:
    ...
    // Fund Users Page
    FUND_USER_SETUP:
        'Manage the users who have access to this fund below. You can edit their permissions at any point.',
    ...
    ADD_FORM_DELEGATE_FORM_ERROR:
        'Note: The delegate you are about to add will receive an email invitation immediately.',
    ...
    redesignPaths: {
        ...
        fund: {
            closingFunctions: `${
                process.env.REACT_APP_NEW_CLOSING === 'true' ? '' : '/redesign'
                }/fund/closingFunctions/`,
