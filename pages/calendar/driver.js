...
const Driver = ({orders, cookies, token}) => {
    ...
    return (
        <React.Fragment>
            <div className="main-dashboard" id="desktop-calendar">
                    <Nav/>
                    <div className="dashboard-main">
                        <div className="dashboard-card" id="calendar-card">
...
Driver.getInitialProps = async ({ req, res }) => {
...
export default connect(mapStateToProps, {getOrders})(Driver);