...
const Withdrawal = ({
  ...
  const getLinkAndRedirect = () => {
    getAccountOnboardingLink({ url: '/dashboard/withdrawal' })
  }
      ...
      <Container>
        ...
        <Content>
          <Notification type="blue" noButton smallMargin>
            ...
            for individuals and businesses. Non-permitted address type may result in delayed or rejected withdrawal
            request.
          </Notification>
        </Content>
        <Cards>
