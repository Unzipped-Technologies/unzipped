    ...
    switch (stage) {
        ...
        case 2:
                ...
                >
                    <Grid>
                        <FormField 
                            ...
                            // currency 
                            onChange={(e) => {
                                ValidationUtils._isNumber(e.target.value.replace(',', '').replace('$', '')) && updateForm({ budget: e.target.value.replace('$', '').replace(',', '') })
                            }}
            ...
            case 12:
                ...
                >
                    <Grid>
                        <Button icon="github" extraTall extraWide noBorder type="dark" normal>CONNECT YOUR GITHUB ACCOUNT</Button>
                    </Grid>
                </CreateABusiness>
                );
            case 13:
                ...
                >
                    <Grid margin="10px 0px">
                        <OptionTileGroup
                            ...
                            margin="5px 0px"
                            onChange={e => updateForm({ typesOfHires: typesOfHires.find(i => i === e.target.value) ? typesOfHires.filter(i => i !== e.target.value) : [...typesOfHires ,e.target.value]})}
                            stage={stage}
                        /> 
                        <OptionTileGroup
                            selectedValue={typesOfHires}
