...
`
const Freelancers = ({ freelancerList = [], getFreelancerList, access_token, totalCount, clearSelectedFreelancer, getFreelancerSkillsList, freelancerSkillsList = [] }) => {
        ...
        <div>
            ...
            <Container>
                ...
                <Box >
                    ...
                    <DesktopSearchFilterFreelancers  maxRate={maxRate} setMaxRate={setMaxRate} setMinRate={setMinRate} minRate={minRate} sort={sort} setSort={setSort} sortOptions={sortOptions}  freelancerSkillsList={freelancerSkillsList} skill={skill} setSkill={setSkill} />
