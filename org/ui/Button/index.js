...
const ButtonContainer = styled.button`
    ...
    border: ${props => (props.noBorder ? '0' : `2px solid ${props.colors.border}`)};
    color: ${props => props.colors.text};
    box-sizing: border-box;
    border-radius: 4px;
    padding: ${props => (props.small ? '7px' : '12px')} ${props => (props.popout ? '12px' : '15px')}
        ${props => (props.small ? '7px' : '12px')} ${props => (props.popout ? '4px' : '15px')};
    font-family: arial;
