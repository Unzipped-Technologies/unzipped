...
import Profile from '../../pages/freelancers/[id]' // Adjust the import path as needed
...
import { getFreelancerById, getInvitesLists, addEntriesToList } from '../../redux/actions'
...
jest.mock('../../redux/ListsAction/actions', () => ({
  ...jest.requireActual('../../redux/ListsAction/actions'),
