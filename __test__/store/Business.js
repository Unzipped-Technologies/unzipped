export const BUSINESS = [
  {
    ...
    isActive: true,
    departments: ['6601c35b149276195c3f8fd5', '6601ce179411991f47005806'],
    applicants: ['6601c2a6149276195c3f8fc2'],
    questionsToAsk: [],
    projectImagesUrl: [],
    name: 'POS',
    budget: 100000,
    ...
    businessDepartments: [
      ...
      {
        _id: '6601ce179411991f47005806',
        tags: ['6601ce179411991f47005807', '6601ce179411991f47005808', '6601ce179411991f47005809'],
        businessId: '6601c35b149276195c3f8fd3',
  ...
  },
  {
    ...
    projectType: 'Short Term Business',
    isActive: true,
    departments: ['661e93017277db0ed9b6ff3e'],
    applicants: [null, '6611b6efa65bc0120aa3394f', '6601c2a6149276195c3f8fc2'],
    questionsToAsk: ['661e93017277db0ed9b6ff3b', '661e93017277db0ed9b6ff3c', '661e93017277db0ed9b6ff3d'],
    projectImagesUrl: ['66106dd562048827e88a67b0'],
    name: 'Hospital Management System',
    budget: 90000,
    userId: '6601c288149276195c3f8faf',
    createdAt: '2024-04-16T15:02:25.121Z',
    updatedAt: '2024-05-11T16:35:55.787Z',
    goals:
    ...
    businessDepartments: [
      {
        ...
        tags: ['661e93017277db0ed9b6ff3f', '661e93017277db0ed9b6ff40', '661e93017277db0ed9b6ff41'],
        name: 'Management',
...

  {
    ...
    description:
      'I am looking for a freelancer to develop a SAAS platform on the cloud that will help businesses reduce their carbon emissions. Here are the project requirements:',
    businessAddressLineOne: '',
    ...
    requiredSkills: ['React', 'Node', 'AWS', 'Redux', 'Express', 'MongoDB'],
    likeTotal: 1450,
    projectBudgetType: 'Fixed Price',
    projectType: 'Short Term Business',
    isActive: true,
    departments: ['66106dd562048827e88a67b3'],
    applicants: ['6601c2a6149276195c3f8fc2'],
    questionsToAsk: [],
    projectImagesUrl: ['66106dd562048827e88a67b0'],
    name: 'Online LMMS',
    budget: 90000,
    userId: '6601c288149276195c3f8faf',
    createdAt: '2024-04-05T21:32:05.324Z',
    updatedAt: '2024-04-29T14:51:03.737Z',
    goals:
      'This is where we are going to put the project description which is defined in the projectDetails portion of the database. It should display the entire thing and then if there are requirements, we will display those below this.',
    projectImages: [
      {
        _id: '66106dd562048827e88a67b0',
        name: 'circularDependency.png',
    ...
    businessDepartments: [
      {
        _id: '66106dd562048827e88a67b3',
        tags: ['66106dd562048827e88a67b4', '66106dd562048827e88a67b5', '66106dd562048827e88a67b6'],
        name: 'Management',
  ...
  },
  {
    ...
    projectType: 'Short Term Business',
    isActive: true,
    departments: ['6601c98c5657f51de61d2621', '6601cf1a9411991f47005812'],
    applicants: [],
    questionsToAsk: [],
    projectImagesUrl: [],
    name: 'Online TOD',
    budget: 90000,
    userId: '6601c288149276195c3f8faf',
    createdAt: '2024-03-25T18:59:24.634Z',
    updatedAt: '2024-04-09T22:33:38.260Z',
    projectImages: [],
    questions: [],
    user: {
      _id: '6601c288149276195c3f8faf',
    ...
    businessDepartments: [
      {
        _id: '6601c98c5657f51de61d2621',
        tags: ['6601c98c5657f51de61d2622', '6601c98c5657f51de61d2623', '6601c98c5657f51de61d2624'],
        name: 'Management',
