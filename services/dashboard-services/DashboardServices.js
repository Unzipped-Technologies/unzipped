...
//         return garages
//     } catch (error) {
//         console.error(`Error: DashboardServices.getAllGarages Failed to find garages: ${error}`)
//     }
// }
...
//         return garages
//     } catch (error) {
//         console.error(`Error: DashboardServices.createGarage Failed to create garage: ${error}`)
//     }
// }
